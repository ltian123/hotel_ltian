  ...
  <div id="content" style="border:solid 1px #ffffff;width:90%;margin:auto;padding-top:10px">
    <form action="${pageContext.request.contextPath }/checked/manager/saveRemarkAndStatus.do" method="post">
        ...
        <div class="row">
          ...
          <div class="column4">
            ...
            <div class="column_2">
              ...
              <option value="0" ${subscription.status eq "0" ? "selected":""}>待确认</option>
              <option value="1"  ${subscription.status eq "1"? "selected": "" }>已确认</option>
              <option value="2" ${subscription.status eq "2"? "selected": "" }>已取消</option>
        ...
        <div class="row">
          ...
          <input type="text" class="text" name="remark" id="remark" value="${subscription.remark}"/> 
      ...
      <tr>
        ...
        <td>
          <div>
	            <a href="${pageContext.request.contextPath }/checked/manager/removeSubscriptionDtl.do?sdid=${subscriptionDtlVo.id}&sid=${subscriptionDtlVo.sid}" onclick="return confirm('真的要删除该预定细信息吗？')">删除</a>
          </div>
        </td>
      </tr>
      </c:forEach>
    ...
    <div class="submit">
      <input type="button" value="返回" onclick="location='${pageContext.request.contextPath }/checked/manager/querySubscriptionList.do'"/>
    </div>
  </div>
  <hr />
